...
\begin{itemize}
    \item E-GraphSAGE for IoT IDS [Lo '22]
    \item GNN-based NIDS [Chang '21]
    \item Botnet detection via topology [Pujol '22]
...
\begin{itemize}
    \item H2GCN [Zhu '20] --- ego/neighbor separation
    \item LINKX [Lim '21] --- decouple structure \& features
    \item \textbf{LSGNN} [Wu '23] --- local similarity weighting
...
\begin{itemize}
    ...
    \item Graph InfoMax [Veli\v{c}kovi\'{c} '19]
